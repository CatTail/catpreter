{ prog: [ [ 'statement' ] ],
  statement: 
   [ [ 'compound_statement' ],
     ...
     [ 'iteration_statement' ],
     [ 'declaration' ] ],
  compound_statement: [ [ '\'{\'', 'compound_statement$c_dHIsJH' ] ],
  ...
  'expression$*': [ [ '\',\'', 'assignment_expression', 'expression$*' ], [] ],
  'equality_expression$*': 
   [ [ 'equality_expression$*$|_lKgIuO', 'equality_expression$*' ],
     [] ],
  'equality_expression$*$|_lKgIuO': 
  ...
  'relational_expression$*': 
   [ [ '\'<\'', 'additive_expression', 'relational_expression$*' ],
     [] ],
  'additive_expression$*': 
   [ [ 'additive_expression$*$|_fvAWUk', 'additive_expression$*' ],
     [] ],
  'additive_expression$*$|_fvAWUk': 
   [ [ '\'+\'', 'multiplicative_expression' ],
     [ '\'-\'', 'multiplicative_expression' ] ],
  'multiplicative_expression$*': 
   [ [ 'multiplicative_expression$*$|_TyURdc',
       'multiplicative_expression$*' ],
     [] ],
  'multiplicative_expression$*$|_TyURdc': 
   [ [ '\'*\'', 'unary_expression' ],
  ...
  'compound_statement$c_dHIsJH': [ [ '\'}\'' ], [ 'statement_list', '\'}\'' ] ] }
