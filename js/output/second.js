...
var grammar = { prog: [ [ 'statement' ] ],
  statement: 
   [ [ 'compound_statement' ],
     ...
     [ 'iteration_statement' ],
     [ 'declaration' ] ],
  compound_statement: [ [ '\'{\'', 'compound_statement$c_jFRLbR' ] ],
  ...
  'expression$*': [ [ '\',\'', 'assignment_expression', 'expression$*' ], [] ],
  'equality_expression$*': 
   [ [ 'equality_expression$*$|_XeZzpv', 'equality_expression$*' ],
     [] ],
  'equality_expression$*$|_XeZzpv': 
  ...
  'relational_expression$*': 
   [ [ '\'<\'', 'additive_expression', 'relational_expression$*' ],
     [] ],
  'additive_expression$*': 
   [ [ 'additive_expression$*$|_sydBNz', 'additive_expression$*' ],
     [] ],
  'additive_expression$*$|_sydBNz': 
   [ [ '\'+\'', 'multiplicative_expression' ],
     [ '\'-\'', 'multiplicative_expression' ] ],
  'multiplicative_expression$*': 
   [ [ 'multiplicative_expression$*$|_ZUggsk',
       'multiplicative_expression$*' ],
     [] ],
  'multiplicative_expression$*$|_ZUggsk': 
   [ [ '\'*\'', 'unary_expression' ],
  ...
  'compound_statement$c_jFRLbR': [ [ '\'}\'' ], [ 'statement_list', '\'}\'' ] ] };
