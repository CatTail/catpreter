...
var EBNF = (function(){
     ...
     * CATTAIL
     * @param {?} e
     * @param {object} opts Refer to optForProduction() for the `opts` object format
     * @param {function} emit
     */
    ...
    /**
     * CATTAIL
     * Handle means a collection of symbol.
     * first item in handle means `handle`, second item means `action` while the third
     * means `opts`.
     * This method transform production's handle into another format, leave action and opts alone.
     * For now I don't know what happends to handle.
     * 
     * 
     * @param {string} id Unterminal symbol
     * @param {array.array|array.string} prodcution production means a collection of handle
     * @param {object} grammar grammar is a collection of production
     */
